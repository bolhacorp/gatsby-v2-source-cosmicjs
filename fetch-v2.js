...
module.exports = async ({
  ...
  buckets/testefertilidade-ttt/objects?
  pretty=true
  &query=%7B%22type%22:%22homepage-client%22%7D
  &limit=10
  &skip=0
  &read_key=RreXbCIUZexMVdGznLObIprxiSHpLd5ixiMY0CExkkZjaN3u1p
  &depth=1
  ...
  */
  ...
  axiosHeader.params = {
    ...
    //"RreXbCIUZexMVdGznLObIprxiSHpLd5ixiMY0CExkkZjaN3u1p",
    depth: 1,
    props
  };
  ...
  try {
    ...
    if (e.response.statusText === 'first byte timeout') {
      console.info('This error is usually caused by API response limits. You may want to ' + 'check to see if you can reduce the amount of data returned by limiting the objects per ' + 'request or limiting the fields/properties requested for those objects.' + '\n\n' + 'See https://docs.cosmicjs.com/rest-api/objects.html#get-objects');
    }
    return [];
  }
...
//# sourceMappingURL=fetch-v2.js.map